...
/**
 * Created by Administrator on 2016/6/17 16:44
 */
        ...
        switch (eventType) {
            ...
            case AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED:
                ...
                if (className.equals("com.tencent.mm.ui.LauncherUI")) {
                    //开始抢红包
                    Log.e("wangshuoElog","开始抢红包");
                    getPacket();
                } else if (className.equals("com.tencent.mm.plugin.luckymoney.ui.LuckyMoneyReceiveUI")) {
                    //开始打开红包
//                    openPacket();
                    Log.e("wangshuoElog","开始打开红包111");
                }
                else if(className.equals("com.tencent.mm.ui.base.p"))
                {
                    openPacket();
                    Log.e("wangshuoElog","开始打开红包222");
                }
                break;
        }
    }
...
//                    .findAccessibilityNodeInfosByText("抢红包");
            .findAccessibilityNodeInfosByViewId("com.tencent.mm:id/b9m");
    ...
    public void recycle(AccessibilityNodeInfo info) {
        if (info.getChildCount() == 0) {
            if(info.getText() != null){
                Log.e("wangshuoElog",info.getText().toString());
