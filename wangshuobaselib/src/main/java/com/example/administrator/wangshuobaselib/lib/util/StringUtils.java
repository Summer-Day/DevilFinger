...
/**
 * 字符串方法类 Created by abu on 2015/12/26.
 */
public class StringUtils {
    ...
    /**
     * 判断金额为类似 1234567890.11 1234567890123
     *
     * @param moneyString 待测金额字符串
     * @return
     */
    public static boolean isMoney(String moneyString) {
        ...
        try {
            ...
            Matcher m = p.matcher(moneyString);
            flag = m.matches();
            double money = JavaTypesHelper.toDouble(moneyString, 0.0);
            if (50.0 > money || money > 2000000.0) {// 50~200万金额
                flag = false;
            }
        } catch (Exception e) {
            flag = false;
    ...
    /**
     * 如果字符串为null或者"null"，则赋值为空
     *
     * @param parsedStr 待测字符串
     * @return Str 如果字符串为null，返回""；否则，直接返回str。
     */
    public static String nullToEmpty(String parsedStr) {
        if (parsedStr == null || "null".equals(parsedStr.toLowerCase())) {
            parsedStr = "";
        }
        return parsedStr;
    }
     ...
     * @return
     */
    public static boolean isPointNumber(String number) {
        try {
     ...
     */
    public static String getTxtTail(String txt, int len) {
    ...
    public static void deleteEditableString(Editable edit, int start, int end) {
        ...
        if (start >= end) {
//            CrashReport.postCatchedException(new Exception("outofrange of delete string[" + edit.toString()
//                    + "], start:" + start + ", end:" + end));
            return;
        }
        if (end > length) {
//            CrashReport.postCatchedException(new Exception("outofrange of delete string[" + edit.toString()
//                    + "], start:" + start + ", end:" + end + ", total length:" + length));
            return;
        }
